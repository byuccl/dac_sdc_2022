...
```
sudo apt install make build-essential cmake graphviz
```
...
Submit your code using a Github tag: `lab1_submission`.  Add your report as a PDF file in your Github repo, in the lab folder.
